...
/**
 * HelloMessageProcessor invokes the {@link com.mycompany.greeting.GreetingModule#hello(java.lang.String)} method in {@link GreetingModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        try {
            ...
            final String _transformedContent = ((String) evaluateAndTransform(getMuleContext(), event, HelloMessageProcessor.class.getDeclaredField("_contentType").getGenericType(), null, content));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GreetingModule) object).hello(_transformedContent);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("hello"), event, e);
        }
    }
